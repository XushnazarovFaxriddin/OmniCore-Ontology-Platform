...
Start-Process powershell -ArgumentList "-NoExit", "-Command", "cd src\core\roots; python -m uvicorn api:app --port 18001 --reload"
Start-Process powershell -ArgumentList "-NoExit", "-Command", "cd src\core\causality; python -m uvicorn api:app --port 18002 --reload"
